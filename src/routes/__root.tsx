    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Halaman yang Anda buka tidak tersedia atau sudah dipindahkan.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Peta Jati Diri — Self-awareness Assessment" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "Peta Jati Diri" },
      {
        ...
        content: "Kenali pola energi diri: apa yang menghidupkan, apa yang menguras, dan apa yang sudah terlatih.",
      },
